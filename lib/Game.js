    ...
    for(var t in treeList){
        ...
        for(var tier = 0; tier < 5; tier++){
            ...
            for(var s in treeList[t].tiers[tier]){
                ...
                //Check for combos
                var combo = null;
                if(skill.type == "combo" && skill.subtype != "upgrade"){
                ...
                if(skill.type == "combo" && skill.subtype != "upgrade") tiers[tier][tiers[tier].length-1]["comboID"] = skill.base;
                else if(skill.type == "combo" && skill.subtype == "upgrade") tiers[tier][tiers[tier].length-1]["comboID"] = skill.comboID;
